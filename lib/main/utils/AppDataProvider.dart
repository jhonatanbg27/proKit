...
List<ProTheme> getThemes() {
  List<ProTheme> list = [];
  list.add(ProTheme(name: 'Pet Adoption', title_name: 'Theme 15 Screens', tag: 'New', show_cover: true, sub_kits: getPetAdoptionKit(), darkThemeSupported: true));
...
ProTheme getFullApps() {
  ...
  list.add(ProTheme(name: 'Relix', tag: 'New', widget: RelixSplashScreen()));
  list.add(ProTheme(name: 'Flix v2', tag: 'New', widget: FvSplashScreen(), darkThemeSupported: true));
